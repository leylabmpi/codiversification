...
#Writing file for Hagay, so he can make the final figure
write_tsv(x=genomeWide_compare, file="/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/instrain_output_for_figure/inStrainOutput_comp5_wMetadata_wNCBI.tsv")
...
Writing enhanced inStrain output file for Hagay to make final figure
```{r}
write_tsv(x=genomeWide_compare, file="/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/instrain_output_for_figure/instrain_output_wmetadata.tsv")
```
