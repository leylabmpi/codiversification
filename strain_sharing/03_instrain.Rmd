...
pdf("/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/final_for_paper/codiversification/strain_sharing/files/StrainSharing_Gabon_old.pdf", width=6.75, height=5.75)
gabon_SS <- comp50 %>%
...
pdf("/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/final_for_paper/codiversification/strain_sharing/files/StrainSharing_Vietnam_old.pdf", width=6.75, height=5.75)
vietnam_SS <- comp50 %>%
...
pdf("/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/final_for_paper/codiversification/strain_sharing/files/StrainSharing_Germany_old.pdf", width=5.27, height=5.75)
germany_SS <- comp50 %>%
