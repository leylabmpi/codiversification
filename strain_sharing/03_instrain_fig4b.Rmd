...
x_axis_labels <- c("Same location\nn = 65", "Same location\nn = 1267", "Different location\nn = 7387")

pdf("/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/final_for_paper/codiversification/strain_sharing/figures/Fig4Bi_StrainSharing_Gabon.pdf", width=5.3, height=3.639)
Gabon_ss <- ggplot(dat_Gabon, aes(x = factor(cat, level = level_order), y = perc_ss, fill = relat)) +
  ...
  scale_y_continuous("Strains shared (%)", limits=c(0, 62), breaks = (seq(0, 50, by = 25)))+
...
level_order <- c("Related","Unrelated\n(same location)","Unrelated\n(different location)")
x_axis_labels <- c("Same location\nn = 43", "Same location\nn = 575", "Different location\nn = 12111")

pdf("/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/final_for_paper/codiversification/strain_sharing/figures/Fig4Bii_StrainSharing_Vietnam.pdf", width=5.3, height=3.639)
...
pdf("/ebio/abt3_projects/HUBIF_metagenomics/code/metagenomes/cophylogeny/instrain/final_for_paper/codiversification/strain_sharing/figures/Fig4Biii_StrainSharing_Germany.pdf", width=5.3, height=3.639)
